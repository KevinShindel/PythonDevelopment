...
def set_default():
    ...
    market = {"sku10666": [1, 2, 3, 4], "sku666": [4, 5, 6, 7], "sku999": [8, 9, 0]}
    ...
    dd = defaultdict(
        list
    )  # создает словарь , вместо KeyError будет создан ключ и пустой список
    dd.update({"sku10666": [1, 2, 3, 4], "sku666": [4, 5, 6, 7], "sku999": [8, 9, 0]})
    print(dd)

    od = OrderedDict(
        {  # хранит ключи в порядке их вставки
            "sku10666": [1, 2, 3, 4],
            "sku666": [4, 5, 6, 7],
            "sku999": [8, 9, 0],
        }
